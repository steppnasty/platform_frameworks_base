...
public class EnableAccessibilityController {
    ...
    public static boolean canEnableAccessibilityViaGesture(Context context) {
        ...
        return Settings.System.getInt(context.getContentResolver(),
                Settings.System.ENABLE_ACCESSIBILITY_GLOBAL_GESTURE_ENABLED, 0) == 1
    ...
    private void enableAccessibility() {
        ...
        if (!keyguardLocked) {
            ...
            Settings.Secure.putInt(resolver, Settings.Secure.ACCESSIBILITY_SCRIPT_INJECTION,
                    1);
            // Turn on accessibility mode last.
            Settings.Secure.putInt(resolver, Settings.Secure.ACCESSIBILITY_ENABLED,
                    1);
