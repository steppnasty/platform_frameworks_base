...
public class KeyguardUpdateMonitor {
    ...
    private static final int MSG_KEYGUARD_VISIBILITY_CHANGED = 310;
    protected static final int MSG_BOOT_COMPLETED = 311;
        ...
        static SimArgs fromIntent(Intent intent) {
            ...
            if (IccCard.INTENT_VALUE_ICC_ABSENT.equals(stateExtra)) {
                ...
                state = IccCard.State.NETWORK_LOCKED;
                        ...
                        || IccCard.INTENT_VALUE_ICC_IMSI.equals(stateExtra)) {
    ...
    private KeyguardUpdateMonitor(Context context) {
        ...
        mSimState = IccCard.State.NOT_READY;
    ...
    private void watchForDeviceProvisioning() {
        ...
        boolean provisioned = Settings.System.getInt(mContext.getContentResolver(),
            Settings.System.DEVICE_PROVISIONED, 0) != 0;
    ...
    public static boolean isSimLocked(IccCard.State state) {
        return state == IccCard.State.PIN_REQUIRED
        || state == IccCard.State.PUK_REQUIRED
        || state == IccCard.State.PERM_DISABLED;
    }
    ...
    public static boolean isSimPinSecure(IccCard.State state) {
        final IccCard.State simState = state;
