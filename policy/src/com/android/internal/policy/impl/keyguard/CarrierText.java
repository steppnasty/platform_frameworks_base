...
public class CarrierText extends TextView {
     ...
     * @return
     */
    private CharSequence getCarrierTextForSimState(IccCard.State simState,
     ...
     */
    private StatusMode getStatusForIccState(IccCard.State simState) {
    ...
    private CharSequence getCarrierHelpTextForSimState(IccCard.State simState,
